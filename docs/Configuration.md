...
| max_alarm_age                | Maximum age of an alarm that is used to make sure old or delayed alarms are ignored (e.g., after a restart of the service or an internet outage)                  | 5 * 60 seconds (5 minutes)    |
