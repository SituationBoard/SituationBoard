...
| startup_action               | Determines whether the screen is left unchanged ("none"), temporarily turned on ("activate"), or explicitly turned off ("deactivate") during startup.             | "activate"                    |
