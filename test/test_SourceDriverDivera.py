...
class Test_SourceDriverDivera:
    ...
    def setup_class(self) -> None:
        ...
        s.setInt(section, "max_alarm_age", 0) # disable age check for testing
        s.setInt(section, "max_alarm_age_startup", 0) # disable age check for testing
        s.setBoolean(section, "use_mock_api", False) # we provide our own instance of the mock API
    ...
    def __checkAlarmEventCommon(self, e: Any, raw: str) -> None:
        ...
        assert(e.sender == SourceDriverDivera.SENDER_DIVERA)
    ...
    def __checkVehicleStatusCommon(self, e: Any, raw: str) -> None:
    ...
    def __checkVehicleStatusNone(self, e: Any, noraw: bool) -> None:
        if noraw:
            self.__checkVehicleStatusCommon(e, "")
        else:
            self.__checkVehicleStatusCommon(e, DiveraMockAPI.VEHICLE_STATUS_NONE)

        assert(e.value == "")

    def __checkVehicleStatus0(self, e: Any) -> None:
        self.__checkVehicleStatusCommon(e, DiveraMockAPI.VEHICLE_STATUS_0)

        assert(e.value == "LF 43/1: Status 2  –  MTW 14/1: Status 2")

    def __checkVehicleStatus1(self, e: Any) -> None:
        self.__checkVehicleStatusCommon(e, DiveraMockAPI.VEHICLE_STATUS_1)
    ...
    def test_source_state(self) -> None:
        ...
        e = self.d.retrieveEvent()
        self.__checkVehicleStatusNone(e, True)
    ...
    def test_vehicle_status(self) -> None:
        ...
        e = self.d.retrieveEvent()
        self.__checkVehicleStatusNone(e, False)
